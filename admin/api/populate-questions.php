...
try {
    ...
    try {
        $log_query = "INSERT INTO activity_logs (action_type, details, ip_address, user_agent) VALUES (?, ?, ?, ?)";
        ...
        $log_stmt->execute(['questions_populated', $log_details, $ip_address, $user_agent]);
    } catch (Exception $e) {
    ...
    echo json_encode([
        'success' => true,
        'message' => "Successfully populated questions directory",
        'total_saved' => $total_saved,
        'details' => $results
    ]);
